...
Dastra unterstützt nativ den **Google Consent Mode V2**. Diese Integration sendet ein `consent_update`-Signal an GTM, sobald ein Nutzer seine Einwilligung ausdrückt, damit die Google-Tags diese Wahl respektieren, bevor ein Tracking ausgelöst wird.
