---
description: >-
  Créez votre compte, configurez votre espace de travail et ajoutez votre
  premier traitement en moins de 5 minutes.
---
...
<figure><img src="../.gitbook/assets/getting-started-workspace-create-form.png" alt="Formulaire de création d'un espace de travail Dastra"><figcaption><p>Donnez un nom à votre espace de travail</p></figcaption></figure>

{% content-ref url="setup/espace-de-travail.md" %}
[En savoir plus sur les espaces de travail](setup/espace-de-travail.md)
{% endcontent-ref %}
...
<figure><img src="../.gitbook/assets/register-processing-create-mode-picker.png" alt="Sélecteur du mode de création d'un traitement dans Dastra : IA, modèle, actif ou personnalisé"><figcaption><p>Choisissez comment créer votre premier traitement</p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/register-processing-create-name-form.png" alt="Formulaire de création d'un traitement avec le champ nom et l'unité organisationnelle"><figcaption><p>Le nom et l'unité organisationnelle sont les seuls champs obligatoires à la création</p></figcaption></figure>
...
[En savoir plus sur le registre des traitements](../features/editer-le-registre/README.md)
{% endcontent-ref %}
...
{% content-ref url="setup/inviter-utilisateurs.md" %}
[En savoir plus sur la gestion des utilisateurs](setup/inviter-utilisateurs.md)
{% endcontent-ref %}
...
{% content-ref url="tutoriel/README.md" %}
[Tutoriel complet — cas pratique RGPD](tutoriel/README.md)
{% endcontent-ref %}

{% content-ref url="setup/README.md" %}
[Configurer votre espace en détail](setup/README.md)
{% endcontent-ref %}

{% content-ref url="../features/editer-le-registre/README.md" %}
[Construire votre registre des traitements](../features/editer-le-registre/README.md)
{% endcontent-ref %}

{% content-ref url="../features/systemes-dia/README.md" %}
[Gouverner vos systèmes d'IA](../features/systemes-dia/README.md)
{% endcontent-ref %}
