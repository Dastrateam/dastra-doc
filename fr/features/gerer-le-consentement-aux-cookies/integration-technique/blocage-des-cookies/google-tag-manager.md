...
Dastra supporte nativement le **Google Consent Mode V2**. Les prérequis, l'activation sur un service et le snippet de consentement par défaut sont décrits dans une page dédiée :
