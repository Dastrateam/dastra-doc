...
<figure><img src="../../.gitbook/assets/violations-create-subprocessor.png" alt="Fenêtre de création d'un incident avec le sélecteur Sous-traitant (Oui/Non)"><figcaption><p>Lors de la création, indiquez si votre organisation intervient en tant que sous-traitant</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/violations-subprocessor-communication-dc.png" alt="Section Communication aux responsables de traitement dans un incident sous-traitant"><figcaption><p>L'onglet Responsables de traitement liste les RT à notifier, avec les boutons Joindre, Synchroniser et Exporter</p></figcaption></figure>
