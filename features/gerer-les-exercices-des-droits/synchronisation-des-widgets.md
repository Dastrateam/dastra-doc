...
1. Ouvrez le widget que vous souhaitez désigner comme source.
2. Accédez aux paramètres de synchronisation et associez les widgets enfants.
3. Lors de toute modification, utilisez **"Propager les modifications"** pour les appliquer aux widgets liés.
