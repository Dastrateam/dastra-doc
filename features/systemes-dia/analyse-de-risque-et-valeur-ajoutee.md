...
{% hint style="info" %}
Si vous déclarez être **déployeur d'un système d'IA** et que celui-ci est définit comme étant à **haut risque**, conformément à l’article 27 du règlement européen sur l’intelligence artificielle (AI Act), vous êtes tenu d’effectuer, avant la mise en service du système, une [**analyse d’impact sur les droits fondamentaux**](analyse-dimpact-sur-les-droits-fondamentaux-fria.md).
{% endhint %}
