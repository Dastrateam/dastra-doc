...
<figure><img src="../../.gitbook/assets/settings-message-templates-create-modal-error.png" alt=""><figcaption><p>Interface de création d'un modèle</p></figcaption></figure>
